...
import type { MedicineLabelResult as _MedicineLabelResult, ProcessLabelResult as _ProcessLabelResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async processLabel(arg0: string, arg1: string): Promise<ProcessLabelResult> {
        if (this.processError) {
            try {
                const result = await this.actor.processLabel(arg0, arg1);
                return from_candid_ProcessLabelResult_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
...
function from_candid_ProcessLabelResult_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProcessLabelResult): ProcessLabelResult {
